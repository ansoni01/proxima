...
import { faAngleDown, faUser, faCog, faCalendarAlt, faSync, faSpinner } from '@fortawesome/free-solid-svg-icons';
import { faSmileBeam, faGrinHearts, faGrinBeamSweat, faGrinSquintTears } from '@fortawesome/free-regular-svg-icons';
import { ColorsService, ThemeColor } from '@core';
