...
const routes: Routes = [
  ...
  { path: 'basic', component: NgxDtBasicComponent, data: { title: extract('Basic Table') } },
  { path: 'styles', component: NgxDtStylesComponent, data: { title: extract('Table Styles') } },
  { path: 'fixed-header', component: NgxDtFixedHeaderComponent, data: { title: extract('Fixed header') } },
  { path: 'checkbox', component: NgxDtCheckboxComponent, data: { title: extract('Table Checkbox') } },

  { path: 'row-details', component: NgxDtRowDetailsComponent, data: { title: extract('Row Details') } },
  { path: 'grouping', component: NgxDtGroupingComponent, data: { title: extract('Grouping') } },
  { path: 'custom-templates', component: NgxDtCustomTemplatesComponent, data: { title: extract('Row Details') } },
  { path: 'filtering', component: NgxDtFilteringComponent, data: { title: extract('Filtering') } },

  { path: 'responsive-template', component: NgxDtResponsiveComponent, data: { title: extract('Responsive Template') } },
  {
  ...
  { path: 'contacts', component: NgxDtRealContactsComponent, data: { title: extract('Contacts') } },
  { path: 'orders', component: NgxDtRealOrdersComponent, data: { title: extract('Orders') } },
];
