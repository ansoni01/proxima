...
const routes: Routes = [
  ...
  { path: 'circled', component: UiWizardCirclesNavComponent, data: { title: extract('Wizard - Circles Navigation') } },
  { path: 'tabbed', component: UiWizardTabsNavComponent, data: { title: extract('Wizard - Tabs Navigation') } },
];
