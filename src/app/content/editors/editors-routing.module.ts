...
const routes: Routes = [
  // Module is lazy loaded, see app-routing.module.ts
  {
    path: 'quill',
    children: [
      { path: 'basic', component: QuillDefaultComponent, data: { title: extract('Quill Default') } },
      { path: 'bubble', component: QuillBubbleComponent, data: { title: extract('Quill Bubble Editor') } },
      { path: 'reactive-forms', component: QuillReactiveFormsComponent, data: { title: extract('Reactive Forms') } },
    ],
  },

  {
    path: 'ckeditor',
    children: [
      { path: 'classic', component: CkDefaultComponent, data: { title: extract('CKEditor Default') } },
      { path: 'binding-options', component: CkBindingOptionsComponent, data: { title: extract('Binding Options') } },
    ],
  },
