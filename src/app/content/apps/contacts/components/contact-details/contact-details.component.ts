...
import { faBuilding, faPlus, faChevronLeft, faTrash, faPen, faUpload } from '@fortawesome/free-solid-svg-icons';
...
export class ContactDetailsComponent extends BaseComponent implements OnInit {
  ...
  constructor(private _contacts: ContactsService, private _router: ActivatedRoute) {
    super();
  }

  ngOnInit() {
    this._router.parent.params.subscribe((params) => this.fetchUser(params['id']));
  }
