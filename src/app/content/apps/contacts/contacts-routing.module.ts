...
const routes: Routes = [
  ...
  { path: 'list', component: ContactsListComponent, data: { title: extract('Contact List') } },
  { path: 'grid', component: ContactsGridComponent, data: { title: extract('Contact Grid') } },
  { path: 'new', component: ContactNewComponent, data: { title: extract('Add Contact') } },
  {
    path: ':id',
    children: [
      { path: '', redirectTo: 'details', pathMatch: 'full' },
      { path: 'edit', component: ContactEditComponent, data: { title: extract('Edit Contact') } },
      { path: 'delete', component: ContactDeleteComponent, data: { title: extract('Delete Contact') } },
      {
        path: 'details',
        component: ContactDetailsComponent,
        children: [
          { path: '', redirectTo: 'personal', pathMatch: 'full' },
          { path: 'personal', component: ContactPersonalComponent, data: { title: extract('Personal Information') } },
          { path: 'documents', component: ContactDocumentsComponent, data: { title: extract('Personal Documents') } },
          { path: 'projects', component: ContactProjectsComponent, data: { title: extract('Contact Projects') } },
          { path: 'analytics', component: ContactAnalyticsComponent, data: { title: extract('Contact Analytics') } },
        ],
      },
    ],
  },
