...
const routes: Routes = [
  ...
  { path: 'home', component: StoreHomeComponent, data: { title: extract('Welcome to our store') } },
  {
    path: 'categories',
    //component: StoreHomeComponent,
    children: [
      { path: '', component: StoreCategoriesComponent, data: { title: extract('All Categories') } },
      { path: ':id', component: StoreCategoryDetailsComponent, data: { title: extract('Category') } },
    ],
  ...
  },
  {
    ...
    children: [
      { path: '', component: StoreSearchProductsComponent, data: { title: extract('Products') } },
      { path: ':id', component: StoreProductDetailsComponent, data: { title: extract('Product details') } },
    ],
