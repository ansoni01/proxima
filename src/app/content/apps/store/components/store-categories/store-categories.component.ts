...
export class StoreCategoriesComponent implements OnInit {
  ...
  constructor(private _categories: StoreCategoriesService, private _scrollToService: ScrollToService) {}

  ngOnInit() {
    this._categories.getWithSubCategories().subscribe((categories) => (this.categories = categories));
  }
