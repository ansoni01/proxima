...
export class StoreSearchProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._brands.getFeaturedBrands(6).subscribe((brands) => (this.criteria.brands = brands));
    this._categories.getFeaturedCategories().subscribe((categories) => (this.criteria.categories = categories));
