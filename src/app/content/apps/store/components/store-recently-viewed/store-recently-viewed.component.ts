...
import { faChevronLeft, faChevronRight, faHeart, faCartPlus } from '@fortawesome/free-solid-svg-icons';
...
export class StoreRecentlyViewedComponent extends BaseComponent implements OnInit {
  products: Product[];
