...
export class SettingsNotificationsComponent extends BaseFormComponent implements OnInit {
  icons = {
    envelope: faEnvelope,
  };
  ...
  activities = [
    {
      ...
      controls: [
        ...
        },
        {
          ...
          description: 'Notify me when someone send me private messages',
          value: true,
        },
        {
          key: 'pushTag',
          name: 'Tag notifications',
          description: 'Receive a push notification when someoe tag me',
          value: false,
        },
      ],
    },
      ...
      controls: [
        {
          key: 'networkNews',
          name: 'News',
          description: 'A weekly email with most important updates from people you follow',
          value: true,
        },
        {
          key: 'networkMeetups',
          name: 'Meetups near me',
          description: 'Notify me when a Meetup is posted near to my location',
          value: false,
        },
        {
          key: 'networkAccount',
          name: 'Account activity',
          description: 'Get important notifications regarding my account activity',
          value: true,
        },
      ],
    },
