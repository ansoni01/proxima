...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'account', component: SettingsAccountComponent, data: { title: extract('Account') } },
      { path: 'personal', component: SettingsPersonalComponent, data: { title: extract('Personal') } },
      { path: 'billing', component: SettingsBillingComponent, data: { title: extract('Billing') } },
      { path: 'notifications', component: SettingsNotificationsComponent, data: { title: extract('Notifications') } },
      { path: 'integrations', component: SettingsIntegrationsComponent, data: { title: extract('Integrations') } },
      { path: 'security', component: SettingsSecurityComponent, data: { title: extract('Security') } },
    ],
  },
