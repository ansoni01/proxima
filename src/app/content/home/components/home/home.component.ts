...
export class HomeComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute, private skipService: SkipService) {
    ...
    this.skipService
      ...
      .subscribe((strategy) =>
        this.route.queryParams.subscribe((params) =>
          this.router.navigate([params.redirect || RedirectURL], { replaceUrl: true })
        )
      );
  }
}
