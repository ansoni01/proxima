...
export class Covid19CountriesDistributionComponent implements OnInit {
  ...
  activeComparator(a: any, b: any, rowA: CountryMetric, rowB: CountryMetric, sortDirection: string) {
    const activeA = rowA.confirmed.today - rowA.recovered.today - rowA.deaths.today;
    const activeB = rowB.confirmed.today - rowB.recovered.today - rowB.deaths.today;
