...
export class Covid19GlobalMetricComponent implements OnInit, OnChanges, AfterViewInit {
  icons = {
    dw: faAngleDown,
    up: faAngleUp,
  };
  ...
  initializeChart() {
    const canvas = (this.miniChart.nativeElement as HTMLCanvasElement).getContext('2d');
