...
const routes: Routes = [
  ...
  { path: 'accordion', component: UiAccordionComponent, data: { title: extract('UI - Accordions') } },
  { path: 'avatars', component: UiAvatarsComponent, data: { title: extract('UI - Avatars') } },
  { path: 'alerts', component: UiAlertsComponent, data: { title: extract('UI - Alerts') } },
  { path: 'buttons', component: UiButtonsComponent, data: { title: extract('UI - Buttons') } },
  { path: 'button-group', component: UiButtonGroupComponent, data: { title: extract('UI - Button Groups') } },
  { path: 'colors', component: UiColorsComponent, data: { title: extract('UI - Colors') } },
  { path: 'dropdowns', component: UiDropdownsComponent, data: { title: extract('UI - DropDowns') } },
  { path: 'modals', component: UiModalsComponent, data: { title: extract('UI - Modals') } },
  { path: 'navigations', component: UiNavigationsComponent, data: { title: extract('UI - Navigations') } },
  { path: 'popover', component: UiPopoverComponent, data: { title: extract('UI - Popover') } },
  { path: 'progress', component: UiProgressComponent, data: { title: extract('UI - Progress') } },
  { path: 'tabs', component: UiTabsComponent, data: { title: extract('UI - Tabs') } },
  { path: 'tooltip', component: UiTooltipComponent, data: { title: extract('UI - Tooltip') } },
  { path: 'typographic', component: UiTypographicComponent, data: { title: extract('UI - Typographic') } },
];
