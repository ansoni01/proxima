...
import { StyleService, ColorVariation } from '@core';
...
export class UiAvatarsComponent implements OnInit {
  ...
  ngOnInit() {
    this._users.getByCount(6).subscribe((users) => this.prepareForDemo(users));
  }
      ...
      return {
        ...
        placeholderBgColor:
          ...
          demo == DemoType.withInfoPlaceholder
            ...
            : null,
        info: demo === DemoType.withInfo || demo == DemoType.withInfoPlaceholder ? item.info : null,
      };
    });
  }
}
